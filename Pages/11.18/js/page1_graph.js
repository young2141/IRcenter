...
function chart1(filename) {
    ...
    $.getJSON("../../json/" + filename, (jsonData) => {
        ...
        var valueY_ko = "값";
        var numberFormat = "#%";
        drawP1Curved(result, divName, cnt, categoryX, valueY, valueY_ko, valueY_RGB, title, numberFormat);
    });
};
chart1("competition_rate.json");
chart1("recruitment_rate.json");