...
function parsing2(year, condition, data1, data2) {
    ...
    $.getJSON("../../json/" + filename, (jsonData) => {
        temp1["competition_rate"] = jsonData[condition][condition + "_competition_rate"];
        temp2["recruitment_rate"] = jsonData[condition][condition + "_recruitment_rate"];
        data1.push(temp1);
        data2.push(temp2);
...
function drawLineChart(_data1, _data2, _condition) {
    am4core.ready(function () {
        ...
        createAxisAndSeries(chart1, "competition_rate", "경쟁률", "#00a686", "경쟁", _condition);
        createAxisAndSeries(chart2, "recruitment_rate", "충원율", "#e8cd05", "충원", _condition);
        // // Add legend
