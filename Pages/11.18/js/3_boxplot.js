...
function drawBoxplotChart(_data, _year) {
    am4core.ready(function () {
        ...
        series.columns.template.adapter.add("stroke", function (stroke, target) {
            if (target.dataItem.categoryX == "학생부교과") return am4core.color("#a9cbe4");
            else if (target.dataItem.categoryX == "논술") return am4core.color("#fac18e");
            else if (target.dataItem.categoryX == "학생부 종합 일반") return am4core.color("#96caac");
            else if (target.dataItem.categoryX == "학생부 종합 농어촌") return am4core.color("#fc9e96");
            else if (target.dataItem.categoryX == "정시일반") return am4core.color("#e1b3fa");
        });
