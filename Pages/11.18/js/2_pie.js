...
function createSeries2(_chart) {
    ...
    pieSeries.slices.template.tooltipText = "[#000]2019학년도 전체 신입생 중 {category} 학생은 [bold]{value}명[\] 입니다.";
    pieSeries.tooltip.label.fill = am4core.color("#000000");
    // This creates initial animation
    pieSeries.hiddenState.properties.opacity = 1;
    pieSeries.hiddenState.properties.endAngle = -90;
    pieSeries.hiddenState.properties.startAngle = -90;
    pieSeries.colors.list = ["#ff3d00", "#ffc102", "#ef5350", "#fdf5bc", "#ff7f27"].map((color) => {
