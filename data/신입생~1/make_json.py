...
for file_name in file_list:
    if file_name.find('.xls') != -1 and int(file_name[:4]) >= 2013:
        ...
        with open('data\신입생~1\\2page_'+str(year)+'.json','w',encoding='UTF-8-sig') as outfile:
