...
function makeDataToDrawGraph1(data) {
    ...
    data.forEach(e => {
        ...
        obj["전임교원_퍼센트"] = obj["전임교원"] / (obj["전임교원"] + obj["비전임교원"] + obj["조교"]) * 100;
        graph_data.push(obj);
    });
...
function drawChart(data) {
    am4core.ready(function () {
        ...
        yAxis2.renderer.minGridDistance = 100;
        yAxis2.renderer.grid.template.location = 0;
        // yAxis2.renderer.labels.template.minGridDistance = 30;
        yAxis2.max = 100;
        yAxis2.min = 0;
        ...
        series4.dataFields.valueY = "전임교원_퍼센트";
        series4.strokeWidth = 4;
        series4.name = "전임교수 꺾은선";
        series4.tooltipText = "{전임교원_퍼센트}";
        series4.yAxis = yAxis2;
